...
% This block needs to be resized to fit within the column
\begin{equation}
...
% Multi-line equation broken to fit the column width
\begin{align}
...
% Long summation equation broken into multiple lines
\begin{align}
    l_t(\theta) &=
...
% Loss functions formatted with cases
\begin{align}
    l_r(u, r) &= 
    \begin{cases} 
        0 & \text{for games} \\
